...
#ifndef DONT_USE_UPLOADTOBLOB
    //REGISTER_GLOBAL_MOCK_RETURN(IoTHubDeviceClient_LL_UploadToBlobAsync, IOTHUB_CLIENT_OK);
    //REGISTER_GLOBAL_MOCK_RETURN(IoTHubDeviceClient_LL_UploadMultipleBlocksToBlobAsync, IOTHUB_CLIENT_OK);
#endif
}
